...
@section('content')
    <div class="row">
        <div class="card card-info col-md-12">
            ...
            <form role="form" method="POST" action="{{ url('imp_contrato/actualizar') }}">
                @csrf
                <input type="hidden" name="id_req" value="{{ $imp->id_req }}">
                <input type="hidden" name="id_imp" value="{{ $imp->id_imp }}">
                <div class="card-body">
                    <div class="row">
                        <div class="col-md-4">
                            <div class="row">
                                <div class="form-group col-md-12">
                                    ...
                                    <input type="text" name="firma1" class="form-control" id="firma1" placeholder="Nombre Completo" value="{{ $imp->firma1 }}" required>
                                ...
                                <div class="form-group col-md-12">
                                    ...
                                    <input type="text" name="cargo1" class="form-control" id="cargo1" placeholder="Cargo" value="{{ $imp->cargo1 }}" required>
                            ...
                            <div class="row">
                                <div class="form-group col-md-12">
                                    ...
                                    <input type="text" name="firma2" class="form-control" id="firma2" placeholder="Nombre Completo" value="{{ $imp->firma2 }}" required>
                                ...
                                <div class="form-group col-md-12">
                                    ...
                                    <input type="text" name="cargo2" class="form-control" id="cargo2" placeholder="Cargo" value="{{ $imp->cargo2 }}" required>
                            ...
                            <div class="row">
                                <div class="form-group col-md-12">
                                    ...
                                    <input type="text" name="firma3" class="form-control" id="firma3" placeholder="Nombre Completo" value="{{ $imp->firma3 }}" required>
                                ...
                                <div class="form-group col-md-12">
                                    ...
                                    <input type="text" name="cargo3" class="form-control" id="cargo3" placeholder="Cargo" value="{{ $imp->cargo3 }}" required>

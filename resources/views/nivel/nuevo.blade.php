            ...
            <form role="form" method="POST" action="{{ url('nivel/nuevo') }}">
                ...
                <div class="card-body">
                    <div class="form-group">
                        ...
                        <select autofocus name="id_are" id="id_are" class="form-control" autofocus required>
                            @foreach ($area as $a)
                    ...
                    <div class="row">
                        <div class="form-group col-md-4">
                            ...
                            <input type="text" name="nivel" class="form-control" id="nivel" placeholder="Escriba el Nivel" value="{{ old('nivel') }}" maxlength="5" required>
                            @if ($errors->has('nivel'))
                                <small class="form-text text-danger">
                                    {{ $errors->first('nivel') }}
                                </small>
                        ...
                        <div class="form-group col-md-4">
                            ...
                            <input type="number" name="horas" class="form-control" id="horas" placeholder="Escriba el Horas" value="{{ old('horas') }}" required>
                            @if ($errors->has('horas'))
                                <small class="form-text text-danger">
                                    {{ $errors->first('horas') }}
                                </small>
                        ...
                        <div class="form-group col-md-4">
                            ...
                            <input type="text" name="tiempo" class="form-control" id="tiempo" placeholder="Escriba el Tiempo" value="{{ old('tiempo') }}" maxlength="100" required>
